...
class Account(BaseCAI):
    def __init__(self, options: Dict):
        ...
        self.avatar: Union[Avatar, None] = None
        ...
        self.first_name: Union[str, None] = options.get("first_name", None)

        self.avatar_type = account.get("avatar_type", "DEFAULT")

        self.is_human = options.get("is_human", True)
        self.email: Union[str, None] = options.get("email", None)
